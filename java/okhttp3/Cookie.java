...
public final class Cookie {
    ...
    public static final class Companion {
        ...
        public final boolean pathMatch(HttpUrl url, String path) {
            ...
            return StringsKt.startsWith$default(encodedPath, path, false, 2, (Object) null) && (StringsKt.endsWith$default(path, MqttTopic.TOPIC_LEVEL_SEPARATOR, false, 2, (Object) null) || encodedPath.charAt(path.length()) == '/');
        }
        ...
        /* JADX WARN: Code restructure failed: missing block: B:89:0x0115, code lost:
            ...
            if (r3 > okhttp3.internal.http.DatesKt.MAX_DATE) goto L59;
         */
        ...
        */
        public final okhttp3.Cookie parse$okhttp(long r25, @org.jetbrains.annotations.NotNull okhttp3.HttpUrl r27, @org.jetbrains.annotations.NotNull java.lang.String r28) {
            /*
    ...
    public int hashCode() {
        ...
        int hashCode3;
        int hashCode4;
        int hashCode5 = (((((((((527 + this.name.hashCode()) * 31) + this.value.hashCode()) * 31) + Long.hashCode(this.expiresAt)) * 31) + this.domain.hashCode()) * 31) + this.path.hashCode()) * 31;
        hashCode = Boolean.valueOf(this.secure).hashCode();
        int i = (hashCode5 + hashCode) * 31;
        hashCode2 = Boolean.valueOf(this.httpOnly).hashCode();
        int i2 = (i + hashCode2) * 31;
        hashCode3 = Boolean.valueOf(this.persistent).hashCode();
        int i3 = (i2 + hashCode3) * 31;
        hashCode4 = Boolean.valueOf(this.hostOnly).hashCode();
        return i3 + hashCode4;
    }
