...
public final class Cache implements Closeable, Flushable {
    ...
    public final File m1496deprecated_directory() {
    ...
    public final CacheRequest put$okhttp(@NotNull Response response) {
        ...
        if ((!Intrinsics.areEqual(method, "GET")) || INSTANCE.hasVaryAll(response)) {
            return null;
        }
        Entry entry = new Entry(response);
        DiskLruCache.Editor editor = (DiskLruCache.Editor) null;
        try {
            editor = DiskLruCache.edit$default(this.cache, INSTANCE.key(response.request().url()), 0L, 2, null);
            if (editor == null) {
                return null;
            }
