...
// import org.codehaus.mojo.animal_sniffer.IgnoreJRERequirement; // Eliminado: anotación no disponible
...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    public static final class Builder {
        ...
        public final Builder m1595addInterceptor(@NotNull final Function1<? super Interceptor.Chain, Response> block) {
        ...
        public final Builder m1596addNetworkInterceptor(@NotNull final Function1<? super Interceptor.Chain, Response> block) {
            Intrinsics.checkNotNullParameter(block, "block");
    ...
    public OkHttpClient(@NotNull Builder builder) {
        ...
        if (!(list instanceof Collection) || !list.isEmpty()) {
            ...
            while (true) {
                if (!it2.hasNext()) {
                    break;
                } else if (((ConnectionSpec) it2.next()).getIsTls()) {
                    z = false;
                    break;
                }
            }
    ...
    public final List<ConnectionSpec> m1575deprecated_connectionSpecs() {
        return this.connectionSpecs;
    }
    ...
    public final List<Interceptor> m1583deprecated_interceptors() {
        return this.interceptors;
    }
    ...
    public final List<Interceptor> m1584deprecated_networkInterceptors() {
        return this.networkInterceptors;
    }
    ...
    public final List<Protocol> m1586deprecated_protocols() {
        return this.protocols;
    }
    ...
    public final SSLSocketFactory m1593deprecated_sslSocketFactory() {
