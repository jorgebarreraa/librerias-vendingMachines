...
public final class HttpUrl {
    ...
    public static final class Builder {
        ...
        public static final class Companion {
            ...
            public final int parsePort(String input, int pos, int limit) {
                try {
                    int parseInt = Integer.parseInt(Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input, pos, limit, "", false, false, false, false, null, rk3288.RK30_PIN7_PD0, null));
        ...
        private final void push(String input, int pos, int limit, boolean addTrailingSlash, boolean alreadyEncoded) {
            String canonicalize$okhttp$default = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input, pos, limit, HttpUrl.PATH_SEGMENT_ENCODE_SET, alreadyEncoded, false, false, false, null, rk3288.RK30_PIN7_PC0, null);
        ...
        public final Builder addEncodedQueryParameter(@NotNull String encodedName, @Nullable String encodedValue) {
            ...
            Intrinsics.checkNotNull(list);
            list.add(Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, encodedName, 0, 0, HttpUrl.QUERY_COMPONENT_REENCODE_SET, true, false, true, false, null, rk3288.RK30_PIN6_PC3, null));
            List<String> list2 = builder.encodedQueryNamesAndValues;
            Intrinsics.checkNotNull(list2);
            list2.add(encodedValue != null ? Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, encodedValue, 0, 0, HttpUrl.QUERY_COMPONENT_REENCODE_SET, true, false, true, false, null, rk3288.RK30_PIN6_PC3, null) : null);
            return builder;
        }
        ...
        public final Builder addQueryParameter(@NotNull String name, @Nullable String value) {
            ...
            List<String> list = builder.encodedQueryNamesAndValues;
            Intrinsics.checkNotNull(list);
            list.add(Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, name, 0, 0, HttpUrl.QUERY_COMPONENT_ENCODE_SET, false, false, true, false, null, rk3288.RK30_PIN6_PD3, null));
            List<String> list2 = builder.encodedQueryNamesAndValues;
            Intrinsics.checkNotNull(list2);
            list2.add(value != null ? Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, value, 0, 0, HttpUrl.QUERY_COMPONENT_ENCODE_SET, false, false, true, false, null, rk3288.RK30_PIN6_PD3, null) : null);
            return builder;
        }
        ...
        public final Builder encodedFragment(@Nullable String encodedFragment) {
            Builder builder = this;
            builder.encodedFragment = encodedFragment != null ? Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, encodedFragment, 0, 0, "", true, false, false, true, null, rk3288.RK30_PIN5_PC3, null) : null;
            return builder;
        }
        ...
        public final Builder encodedPassword(@NotNull String encodedPassword) {
            ...
            Builder builder = this;
            builder.encodedPassword = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, encodedPassword, 0, 0, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, null, rk3288.RK30_PIN7_PC3, null);
            return builder;
        }
        ...
        public final Builder encodedQuery(@Nullable String encodedQuery) {
            ...
            Builder builder = this;
            builder.encodedQueryNamesAndValues = (encodedQuery == null || (canonicalize$okhttp$default = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, encodedQuery, 0, 0, HttpUrl.QUERY_ENCODE_SET, true, false, true, false, null, rk3288.RK30_PIN6_PC3, null)) == null) ? null : HttpUrl.INSTANCE.toQueryNamesAndValues$okhttp(canonicalize$okhttp$default);
            return builder;
        }
        ...
        public final Builder encodedUsername(@NotNull String encodedUsername) {
            ...
            Builder builder = this;
            builder.encodedUsername = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, encodedUsername, 0, 0, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, null, rk3288.RK30_PIN7_PC3, null);
            return builder;
        }
        ...
        public final Builder fragment(@Nullable String fragment) {
            Builder builder = this;
            builder.encodedFragment = fragment != null ? Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, fragment, 0, 0, "", false, false, false, true, null, rk3288.RK30_PIN5_PD3, null) : null;
            return builder;
        }
        ...
        public final Builder parse$okhttp(@Nullable HttpUrl base, @NotNull String input) {
            ...
            int schemeDelimiterOffset = INSTANCE.schemeDelimiterOffset(input, indexOfFirstNonAsciiWhitespace$default, indexOfLastNonAsciiWhitespace$default);
            ...
            int slashCount = INSTANCE.slashCount(input, indexOfFirstNonAsciiWhitespace$default, indexOfLastNonAsciiWhitespace$default);
            char c2 = '?';
            char c3 = '#';
            if (slashCount >= 2 || base == null || (!Intrinsics.areEqual(base.scheme(), this.scheme))) {
                ...
                while (true) {
                    ...
                    if (charAt != '@') {
                        ...
                        if (z) {
                            ...
                            str2 = str3;
                            i5 = delimiterOffset;
                            sb2.append(Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input, i6, delimiterOffset, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, null, rk3288.RK30_PIN7_PC0, null));
                            this.encodedPassword = sb2.toString();
                        } else {
                            int delimiterOffset2 = Util.delimiterOffset(input, ':', i6, delimiterOffset);
                            i4 = indexOfLastNonAsciiWhitespace$default;
                            String str4 = str3;
                            String canonicalize$okhttp$default = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input, i6, delimiterOffset2, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, null, rk3288.RK30_PIN7_PC0, null);
                            if (z2) {
                                canonicalize$okhttp$default = this.encodedUsername + "%40" + canonicalize$okhttp$default;
                            }
                            this.encodedUsername = canonicalize$okhttp$default;
                            if (delimiterOffset2 != delimiterOffset) {
                                this.encodedPassword = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input, delimiterOffset2 + 1, delimiterOffset, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, null, rk3288.RK30_PIN7_PC0, null);
                                z = true;
                            }
                            str2 = str4;
                            z2 = true;
                ...
                i2 = delimiterOffset;
                int portColonOffset = INSTANCE.portColonOffset(input, i6, i2);
                ...
                if (i7 < i2) {
                    ...
                    this.port = INSTANCE.parsePort(input, i7, i2);
                    if (!(this.port != -1)) {
                    ...
                    i3 = i6;
                    str = str5;
                    this.host = HostnamesKt.toCanonicalHost(Companion.percentDecode$okhttp$default(HttpUrl.INSTANCE, input, i3, portColonOffset, false, 4, null));
                    Companion companion = HttpUrl.INSTANCE;
            ...
            int i8 = i;
            int delimiterOffset3 = Util.delimiterOffset(input, "?#", i2, i8);
            resolvePath(input, i2, delimiterOffset3);
            if (delimiterOffset3 < i8 && input.charAt(delimiterOffset3) == '?') {
                int delimiterOffset4 = Util.delimiterOffset(input, '#', delimiterOffset3, i8);
                this.encodedQueryNamesAndValues = HttpUrl.INSTANCE.toQueryNamesAndValues$okhttp(Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input, delimiterOffset3 + 1, delimiterOffset4, HttpUrl.QUERY_ENCODE_SET, true, false, true, false, null, rk3288.RK30_PIN6_PC0, null));
                delimiterOffset3 = delimiterOffset4;
            }
            if (delimiterOffset3 < i8 && input.charAt(delimiterOffset3) == '#') {
                this.encodedFragment = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input, delimiterOffset3 + 1, i8, "", true, false, false, true, null, rk3288.RK30_PIN5_PC0, null);
            }
            return this;
        }
        ...
        public final Builder password(@NotNull String password) {
            ...
            Builder builder = this;
            builder.encodedPassword = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, password, 0, 0, " \"':;<=>@[]^`{}|/\\?#", false, false, false, false, null, rk3288.RK30_PIN7_PD3, null);
            return builder;
        }
        ...
        public final Builder query(@Nullable String query) {
            String canonicalize$okhttp$default;
            Builder builder = this;
            builder.encodedQueryNamesAndValues = (query == null || (canonicalize$okhttp$default = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, query, 0, 0, HttpUrl.QUERY_ENCODE_SET, false, false, true, false, null, rk3288.RK30_PIN6_PD3, null)) == null) ? null : HttpUrl.INSTANCE.toQueryNamesAndValues$okhttp(canonicalize$okhttp$default);
            return builder;
        }
        ...
        public final Builder reencodeForUri$okhttp() {
            ...
            for (int i = 0; i < size; i++) {
                builder.encodedPathSegments.set(i, Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, builder.encodedPathSegments.get(i), 0, 0, HttpUrl.PATH_SEGMENT_ENCODE_SET_URI, true, true, false, false, null, rk3288.RK30_PIN7_PA3, null));
            }
            List<String> list = builder.encodedQueryNamesAndValues;
            if (list != null) {
                int size2 = list.size();
                for (int i2 = 0; i2 < size2; i2++) {
                    ...
                    list.set(i2, str2 != null ? Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, str2, 0, 0, HttpUrl.QUERY_COMPONENT_ENCODE_SET_URI, true, true, true, false, null, rk3288.RK30_PIN6_PA3, null) : null);
                }
            }
        ...
        public final Builder removeAllEncodedQueryParameters(@NotNull String encodedName) {
            ...
            builder.removeAllCanonicalQueryParameters(Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, encodedName, 0, 0, HttpUrl.QUERY_COMPONENT_REENCODE_SET, true, false, true, false, null, rk3288.RK30_PIN6_PC3, null));
            return builder;
        }
        ...
        public final Builder removeAllQueryParameters(@NotNull String name) {
            ...
            builder.removeAllCanonicalQueryParameters(Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, name, 0, 0, HttpUrl.QUERY_COMPONENT_ENCODE_SET, false, false, true, false, null, rk3288.RK30_PIN6_PD3, null));
            return builder;
        }
        ...
        public final Builder setEncodedPathSegment(int index, @NotNull String encodedPathSegment) {
            Intrinsics.checkNotNullParameter(encodedPathSegment, "encodedPathSegment");
            Builder builder = this;
            String canonicalize$okhttp$default = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, encodedPathSegment, 0, 0, HttpUrl.PATH_SEGMENT_ENCODE_SET, true, false, false, false, null, rk3288.RK30_PIN7_PC3, null);
        ...
        public final Builder setPathSegment(int index, @NotNull String pathSegment) {
            Intrinsics.checkNotNullParameter(pathSegment, "pathSegment");
            Builder builder = this;
            String canonicalize$okhttp$default = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, pathSegment, 0, 0, HttpUrl.PATH_SEGMENT_ENCODE_SET, false, false, false, false, null, rk3288.RK30_PIN7_PD3, null);
            if ((builder.isDot(canonicalize$okhttp$default) || builder.isDotDot(canonicalize$okhttp$default)) ? false : true) {
                builder.encodedPathSegments.set(index, canonicalize$okhttp$default);
                return builder;
            }
        ...
        */
        ...
        public final Builder username(@NotNull String username) {
            ...
            Builder builder = this;
            builder.encodedUsername = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, username, 0, 0, " \"':;<=>@[]^`{}|/\\?#", false, false, false, false, null, rk3288.RK30_PIN7_PD3, null);
            return builder;
        }
    }
    ...
    public static final class Companion {
        ...
        public final HttpUrl m1555deprecated_get(@NotNull String url) {
        ...
        @Nullable
        /* renamed from: -deprecated_get, reason: not valid java name */
        public final HttpUrl m1556deprecated_get(@NotNull URI uri) {
        ...
        @Nullable
        /* renamed from: -deprecated_get, reason: not valid java name */
        public final HttpUrl m1557deprecated_get(@NotNull URL url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return get(url);
        }
        ...
        public final HttpUrl m1558deprecated_parse(@NotNull String url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return parse(url);
        }
    ...
    public final String m1536deprecated_encodedFragment() {
    ...
    public final String m1537deprecated_encodedPassword() {
    ...
    public final String m1538deprecated_encodedPath() {
        return encodedPath();
    }
    ...
    public final List<String> m1539deprecated_encodedPathSegments() {
    ...
    public final String m1540deprecated_encodedQuery() {
        return encodedQuery();
    }
    ...
    public final String m1541deprecated_encodedUsername() {
    ...
    public final List<String> m1545deprecated_pathSegments() {
    ...
    public final int m1546deprecated_pathSize() {
        return pathSize();
    }
    ...
    public final String m1548deprecated_query() {
        return query();
    }
    ...
    public final Set<String> m1549deprecated_queryParameterNames() {
    ...
    public final int m1550deprecated_querySize() {
        return querySize();
    }
    ...
    public final URI m1552deprecated_uri() {
        return uri();
    }
    ...
    public final URL m1553deprecated_url() {
        return url();
    }
