...
public class JavaBeanInfo {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:212:0x078c, code lost:
    ...
    /* JADX WARN: Type inference failed for: r0v42, types: [java.lang.reflect.Type[]] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public static com.alibaba.fastjson.parser.JavaBeanInfo build(java.lang.Class<?> r36, int r37, java.lang.reflect.Type r38, boolean r39, boolean r40, boolean r41, boolean r42, com.alibaba.fastjson.PropertyNamingStrategy r43) {
        /*
    ...
    private FieldInfo[] computeSortedFields(FieldInfo[] fieldInfoArr, FieldInfo[] fieldInfoArr2) {
        ...
        if (jSONType != null && (orders = jSONType.orders()) != null && orders.length != 0) {
            ...
            for (int i8 = 0; i8 < fieldInfoArr2.length; i8++) {
                for (int i9 = 0; i9 < fieldInfoArr4.length && i9 < length; i9++) {
