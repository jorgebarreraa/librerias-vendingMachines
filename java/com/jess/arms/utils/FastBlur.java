...
public class FastBlur {
    ...
    public static void blur(Context context, Bitmap bitmap, View view) {
        ...
        view.setBackgroundDrawable(new BitmapDrawable(context.getResources(), doBlur(createBitmap, (int) 15.0f, true)));
        Log.w("test", "cost " + (System.currentTimeMillis() - currentTimeMillis) + "ms");
    }
    ...
    public static Bitmap blurBitmap(Bitmap bitmap, int i, int i2) {
        ...
        float f = i;
        float f2 = i2;
        Bitmap reSizeBitmap = DrawableProvider.getReSizeBitmap(bitmap, f, f2);
        ...
        paint.setFlags(2);
        canvas.drawBitmap(reSizeBitmap, 0.0f, 0.0f, paint);
        Bitmap doBlur = doBlur(createBitmap, (int) 15.0f, true);
        Log.w("test", "cost " + (System.currentTimeMillis() - currentTimeMillis) + "ms");
        return doBlur;
    }
