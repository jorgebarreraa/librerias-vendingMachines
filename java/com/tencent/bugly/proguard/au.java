        ...
        try {
            try {
                ...
                if (!c.f && auVar.b.b()) {
                    ...
                    as.a(str4, ap.a(), auVar.c.d, currentThread.getName(), str + ShellUtils.COMMAND_LINE_END + str2 + ShellUtils.COMMAND_LINE_END + str3, null);
                ...
                as.a(str4, ap.a(), auVar.c.d, currentThread.getName(), str + ShellUtils.COMMAND_LINE_END + str2 + ShellUtils.COMMAND_LINE_END + str3, crashDetailBean);
                as asVar = auVar.d;
                if (at.a().C) {
                    z = false;
                }
