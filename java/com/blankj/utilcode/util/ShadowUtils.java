    ...
    public static class ShadowDrawable extends DrawableWrapper {
        ...
        private void buildShadowCorners() {
            if (!this.isCircle) {
                ...
                float f3 = -rectF2.top;
                if (f3 > 0.0f) {
                    this.mCornerShadowPaint.setShader(new RadialGradient(0.0f, 0.0f, f3, new int[]{0, this.mShadowStartColor, this.mShadowEndColor}, new float[]{0.0f, this.mCornerRadius / f3, 1.0f}, Shader.TileMode.CLAMP));
                }
            ...
            this.mCornerShadowPath.setFillType(Path.FillType.EVEN_ODD);
            this.mCornerShadowPath.moveTo(f4, 0.0f);
            this.mCornerShadowPath.rLineTo(-this.mShadowSize, 0.0f);
            ...
            float f6 = -rectF4.top;
            if (f6 > 0.0f) {
                this.mCornerShadowPaint.setShader(new RadialGradient(0.0f, 0.0f, f6, new int[]{0, this.mShadowStartColor, this.mShadowEndColor}, new float[]{0.0f, width / f6, 1.0f}, Shader.TileMode.CLAMP));
            }
        }
