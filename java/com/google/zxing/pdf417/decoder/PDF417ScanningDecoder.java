    ...
    public static DecoderResult decode(BitMatrix bitMatrix, ResultPoint resultPoint, ResultPoint resultPoint2, ResultPoint resultPoint3, ResultPoint resultPoint4, int i, int i2) throws NotFoundException, FormatException, ChecksumException {
        ...
        for (int i9 = 1; i9 <= barcodeColumnCount; i9++) {
            ...
            if (detectionResult.getDetectionResultColumn(i10) == null) {
                DetectionResultColumn detectionResultRowIndicatorColumn4 = (i10 == 0 || i10 == barcodeColumnCount) ? new DetectionResultRowIndicatorColumn(boundingBox, i10 == 0) : new DetectionResultColumn(boundingBox);
                detectionResult.setDetectionResultColumn(i10, detectionResultRowIndicatorColumn4);
                int i11 = -1;
                int i12 = i8;
                int i13 = -1;
                int i14 = i7;
                ...
                while (minY <= boundingBox.getMaxY()) {
                    ...
                    i4 = i13;
                    int i15 = i12;
                    Codeword detectCodeword = detectCodeword(bitMatrix, boundingBox.getMinX(), boundingBox.getMaxX(), z, i3, minY, i14, i15);
