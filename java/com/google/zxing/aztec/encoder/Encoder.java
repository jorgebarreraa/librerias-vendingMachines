    ...
    public static AztecCode encode(byte[] bArr, int i, int i2) {
        ...
        if (i2 == 0) {
            ...
            while (i9 <= 32) {
                ...
                if (size2 <= i11) {
                    ...
                    int i12 = i11 - (i11 % i3);
                    if ((!z2 || bitArray2.getSize() <= i3 * 64) && bitArray2.getSize() + size <= i12) {
                        bitArray = bitArray2;
                        z = z2;
                        i4 = i10;
                        i5 = i11;
        ...
        if (z) {
            ...
            for (int i19 = 0; i19 < i17; i19++) {
                ...
                iArr2[i17 + i19] = (i19 / 15) + i19 + i18 + i8;
            }
        }
        ...
        int i21 = 0;
        while (i20 < i4) {
            int i22 = z ? ((i4 - i20) * 4) + 9 : ((i4 - i20) * 4) + 12;
            int i23 = 0;
            while (i23 < i22) {
                int i24 = i23 * 2;
                while (i7 < i15) {
                    if (generateCheckWords.get(i21 + i24 + i7)) {
                        int i25 = i20 * 2;
                        bitMatrix.set(iArr2[i25 + i7], iArr2[i25 + i23]);
                    }
                    if (generateCheckWords.get((i22 * 2) + i21 + i24 + i7)) {
                        int i26 = i20 * 2;
                        bitMatrix.set(iArr2[i26 + i23], iArr2[((i14 - 1) - i26) - i7]);
                    }
                    if (generateCheckWords.get((i22 * 4) + i21 + i24 + i7)) {
                        int i27 = (i14 - 1) - (i20 * 2);
                        bitMatrix.set(iArr2[i27 - i7], iArr2[i27 - i23]);
                    }
                    if (generateCheckWords.get((i22 * 6) + i21 + i24 + i7)) {
                        int i28 = i20 * 2;
                        bitMatrix.set(iArr2[((i14 - 1) - i28) - i23], iArr2[i28 + i7]);
                    }
                    i7++;
                    i15 = 2;
                }
