...
public final class Detector {
    ...
    public DetectorResult detect() throws NotFoundException {
        ...
        increment(hashMap, arrayList.get(0).getFrom());
        increment(hashMap, arrayList.get(0).getTo());
        increment(hashMap, arrayList.get(1).getFrom());
        increment(hashMap, arrayList.get(1).getTo());
        increment(hashMap, arrayList.get(2).getFrom());
        increment(hashMap, arrayList.get(2).getTo());
        increment(hashMap, arrayList.get(3).getFrom());
        increment(hashMap, arrayList.get(3).getTo());
        ...
        ResultPoint[] r4 = new ResultPoint[]{anonymousClass1, obj, obj2};
        ...
        if (i * 4 >= i2 * 7 || i2 * 4 >= i * 7) {
            resultPoint = r6;
            correctTopRightRectangular = correctTopRightRectangular(r22, r14, r6, resultPoint6, i, i2);
            if (correctTopRightRectangular == null) {
                correctTopRightRectangular = resultPoint6;
            }
            ...
            sampleGrid = sampleGrid(this.image, resultPoint, r22, r14, correctTopRightRectangular, i3, transitions4);
        } else {
            correctTopRightRectangular = correctTopRight(r22, r14, r6, resultPoint6, Math.min(i2, i));
            if (correctTopRightRectangular == null) {
                correctTopRightRectangular = resultPoint6;
            }
        ...
        return new DetectorResult(sampleGrid, new ResultPoint[]{resultPoint, r22, r14, correctTopRightRectangular});
    }
}