            ...
            public void onItemSelected(int i13) {
                ...
                if (WheelTime.this.startYear == WheelTime.this.endYear) {
                    ...
                    if (WheelTime.this.startMonth == WheelTime.this.endMonth) {
                        ...
                        wheelTime.setReDay(i14, i15, wheelTime.startDay, WheelTime.this.endDay, asList, asList2);
                    } else if (i15 == WheelTime.this.startMonth) {
                        WheelTime wheelTime2 = WheelTime.this;
                        wheelTime2.setReDay(i14, i15, wheelTime2.startDay, 31, asList, asList2);
                    } else if (i15 == WheelTime.this.endMonth) {
                        WheelTime wheelTime3 = WheelTime.this;
                        wheelTime3.setReDay(i14, i15, 1, wheelTime3.endDay, asList, asList2);
                    } else {
        ...
        this.wv_month.setOnItemSelectedListener(new OnItemSelectedListener() { // from class: com.bigkoo.pickerview.view.WheelTime.4
            ...
            public void onItemSelected(int i13) {
                ...
                if (WheelTime.this.startYear == WheelTime.this.endYear) {
                    ...
                    if (WheelTime.this.startMonth == WheelTime.this.endMonth) {
                        WheelTime wheelTime = WheelTime.this;
                        wheelTime.setReDay(wheelTime.currentYear, i15, WheelTime.this.startDay, WheelTime.this.endDay, asList, asList2);
                    } else if (WheelTime.this.startMonth == i15) {
                        WheelTime wheelTime2 = WheelTime.this;
                        wheelTime2.setReDay(wheelTime2.currentYear, i15, WheelTime.this.startDay, 31, asList, asList2);
                    } else if (WheelTime.this.endMonth == i15) {
                        WheelTime wheelTime3 = WheelTime.this;
                        wheelTime3.setReDay(wheelTime3.currentYear, i15, 1, WheelTime.this.endDay, asList, asList2);
                    } else {
                        WheelTime wheelTime4 = WheelTime.this;
                        wheelTime4.setReDay(wheelTime4.currentYear, i15, 1, 31, asList, asList2);
                    }
                    ...
                    wheelTime7.setReDay(wheelTime7.currentYear, i14, 1, 31, asList, asList2);
                } else if (i14 == WheelTime.this.endMonth) {
