...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public final byte m1621deprecated_getByte(long index) {
    ...
    public long indexOf(byte b, long fromIndex, long toIndex) {
        ...
        if (size() - fromIndex < fromIndex) {
            ...
            while (j < toIndex) {
                ...
                fromIndex = (segment.limit - segment.pos) + j;
                segment = segment.next;
                Intrinsics.checkNotNull(segment);
                j = fromIndex;
            }
    ...
    /* JADX WARN: Removed duplicated region for block: B:48:0x00c7 A[EDGE_INSN: B:48:0x00c7->B:42:0x00c7 BREAK  A[LOOP:0: B:4:0x0012->B:47:?], SYNTHETIC] */
    ...
    */
            ...
            if (charAt < 128) {
                ...
                if (charAt < 2048) {
                    ...
                    if (charAt > 56319 || 56320 > charAt3 || 57343 < charAt3) {
                        ...
                        writableSegment$okio4.data[writableSegment$okio4.limit] = (byte) ((i4 >> 18) | rk3288.RK30_PIN7_PC0);
    ...
    public Buffer writeUtf8CodePoint(int codePoint) {
        if (codePoint < 128) {
            ...
            Segment writableSegment$okio = writableSegment$okio(2);
            writableSegment$okio.data[writableSegment$okio.limit] = (byte) ((codePoint >> 6) | rk3288.RK30_PIN6_PA0);
            ...
            writableSegment$okio2.data[writableSegment$okio2.limit] = (byte) ((codePoint >> 12) | rk3288.RK30_PIN7_PA0);
            ...
            writableSegment$okio3.data[writableSegment$okio3.limit] = (byte) ((codePoint >> 18) | rk3288.RK30_PIN7_PC0);
