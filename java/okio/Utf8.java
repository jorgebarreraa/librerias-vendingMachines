...
public final class Utf8 {
    ...
    public static final int process3Utf8Bytes(@NotNull byte[] process3Utf8Bytes, int i, int i2, @NotNull Function1<? super Integer, Unit> yield) {
        ...
        int i5 = ((b3 ^ ByteCompanionObject.MIN_VALUE) ^ (b2 << 6)) ^ (b << MqttWireMessage.MESSAGE_TYPE_PINGREQ);
        if (i5 < 2048) {
            yield.invoke(valueOf);
            return 3;
        }
    ...
    public static final int process4Utf8Bytes(@NotNull byte[] process4Utf8Bytes, int i, int i2, @NotNull Function1<? super Integer, Unit> yield) {
        ...
        int i6 = (((b4 ^ ByteCompanionObject.MIN_VALUE) ^ (b3 << 6)) ^ (b2 << MqttWireMessage.MESSAGE_TYPE_PINGREQ)) ^ (b << 18);
        if (i6 > 1114111) {
            yield.invoke(valueOf);
            return 4;
        }
        ...
        while (i < i2) {
            ...
            if (Intrinsics.compare((int) charAt2, 128) < 0) {
                ...
                if (Intrinsics.compare((int) charAt2, 2048) < 0) {
                    yield.invoke(Byte.valueOf((byte) ((charAt2 >> 6) | rk3288.RK30_PIN6_PA0)));
                    yield.invoke(Byte.valueOf((byte) ((charAt2 & '?') | 128)));
                } else if (55296 > charAt2 || 57343 < charAt2) {
                    yield.invoke(Byte.valueOf((byte) ((charAt2 >> '\f') | rk3288.RK30_PIN7_PA0)));
                    ...
                    yield.invoke(Byte.valueOf((byte) ((charAt3 >> 18) | rk3288.RK30_PIN7_PC0)));
