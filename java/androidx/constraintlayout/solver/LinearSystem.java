...
public class LinearSystem {
    ...
    private void displayRows() {
        ...
        String str = "";
        for (int i = 0; i < this.mNumRows; i++) {
            str = (str + this.mRows[i]) + ShellUtils.COMMAND_LINE_END;
        }
        System.out.println(str + this.mGoal + ShellUtils.COMMAND_LINE_END);
    }
    ...
    void displayReadableRows() {
        ...
        if (this.mGoal != null) {
            str = str + this.mGoal + ShellUtils.COMMAND_LINE_END;
        }
    ...
    public void displayVariablesReadableRows() {
        ...
        for (int i = 0; i < this.mNumRows; i++) {
            if (this.mRows[i].variable.mType == SolverVariable.Type.UNRESTRICTED) {
                str = (str + this.mRows[i].toReadableString()) + ShellUtils.COMMAND_LINE_END;
            }
        }
        System.out.println(str + this.mGoal + ShellUtils.COMMAND_LINE_END);
    }
