...
public class LiveDataUtils {
    ...
    public class AnonymousClass1<In> implements Observer<In> {
        ...
        public void onChanged(@Nullable final In in) {
            this.val$workTaskExecutor.executeOnBackgroundThread(new Runnable() { // from class: androidx.work.impl.utils.LiveDataUtils.1.1
                ...
                /* JADX WARN: Type inference failed for: r1v3, types: [java.lang.Object, Object] */
    ...
    public static <In, Object> LiveData<Object> dedupedMappedLiveDataFor(@NonNull LiveData<In> liveData, @NonNull Function<In, Object> function, @NonNull TaskExecutor taskExecutor) {
