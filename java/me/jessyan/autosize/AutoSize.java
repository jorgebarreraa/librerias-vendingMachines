...
public final class AutoSize {
    ...
    public static void autoConvertDensity(Activity activity, float f, boolean z) {
        ...
        int round = Math.round((f + designWidth + (z ? AutoSizeConfig.getInstance().getScreenWidth() : AutoSizeConfig.getInstance().getScreenHeight())) * AutoSizeConfig.getInstance().getInitScaledDensity()) & 1073741823;
        ...
        if (displayMetricsInfo == null) {
            ...
            mCache.put(i2, new DisplayMetricsInfo(density, densityDpi, privateFontScale, screenWidth, screenWidthDp, screenHeightDp));
