...
public final class ObservableFromIterable<T> extends Observable<T> {
    ...
    static final class FromIterableDisposable<T> extends BasicQueueDisposable<T> {
        ...
        public T poll() {
            ...
            return (T) ObjectHelper.requireNonNull(this.f7it.next(), "The iterator returned a null value");
        }
        ...
        void run() {
            while (!isDisposed()) {
                try {
                    this.downstream.onNext(ObjectHelper.requireNonNull(this.f7it.next(), "The iterator returned a null value"));
                    if (isDisposed()) {
                        return;
                    }
                    try {
