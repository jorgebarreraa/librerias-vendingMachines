...
public final class UByteArray implements Collection<UByte>, KMappedMarker {
    ...
    public static final class Iterator implements java.util.Iterator<UByte>, KMappedMarker {
        ...
        public /* bridge */ /* synthetic */ UByte next() {
            return UByte.m27boximpl(m100nextw2LRezQ());
        }
    ...
    public static final /* synthetic */ UByteArray m83boximpl(byte[] bArr) {
        return new UByteArray(bArr);
    }

    @NotNull
    /* renamed from: constructor-impl, reason: not valid java name */
    public static byte[] m84constructorimpl(int i) {
        return m85constructorimpl(new byte[i]);
    }

    @PublishedApi
    @NotNull
    /* renamed from: constructor-impl, reason: not valid java name */
    public static byte[] m85constructorimpl(@NotNull byte[] storage) {
        Intrinsics.checkNotNullParameter(storage, "storage");
        return storage;
    }

    /* renamed from: contains-7apg3OU, reason: not valid java name */
    public static boolean m86contains7apg3OU(byte[] bArr, byte b) {
        return ArraysKt.contains(bArr, b);
    }

    /* renamed from: containsAll-impl, reason: not valid java name */
    public static boolean m87containsAllimpl(byte[] bArr, @NotNull Collection<UByte> elements) {
    ...
    public static final byte m90getw2LRezQ(byte[] bArr, int i) {
        return UByte.m33constructorimpl(bArr[i]);
    }
    ...
    public static java.util.Iterator<UByte> m94iteratorimpl(byte[] bArr) {
        return new Iterator(bArr);
    }

    /* renamed from: set-VurrAj0, reason: not valid java name */
    public static final void m95setVurrAj0(byte[] bArr, int i, byte b) {
        bArr[i] = b;
    }
    ...
    public boolean m97add7apg3OU(byte b) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UByte) {
            return m98contains7apg3OU(((UByte) obj).getData());
        }
        return false;
    }

    /* renamed from: contains-7apg3OU, reason: not valid java name */
    public boolean m98contains7apg3OU(byte b) {
        return m86contains7apg3OU(this.storage, b);
    }

    @Override // java.util.Collection
    public boolean containsAll(@NotNull Collection<? extends Object> elements) {
        Intrinsics.checkNotNullParameter(elements, "elements");
        return m87containsAllimpl(this.storage, elements);
    }

    @Override // java.util.Collection
    public boolean equals(Object obj) {
        return m88equalsimpl(this.storage, obj);
    }

    @Override // java.util.Collection
    /* renamed from: getSize, reason: merged with bridge method [inline-methods] */
    public int size() {
        return m91getSizeimpl(this.storage);
    }

    @Override // java.util.Collection
    public int hashCode() {
        return m92hashCodeimpl(this.storage);
    }

    @Override // java.util.Collection
    public boolean isEmpty() {
        return m93isEmptyimpl(this.storage);
    }

    @Override // java.util.Collection, java.lang.Iterable
    @NotNull
    public java.util.Iterator<UByte> iterator() {
        return m94iteratorimpl(this.storage);
    }
    ...
    public String toString() {
        return m96toStringimpl(this.storage);
    }
