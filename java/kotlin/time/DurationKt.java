...
public final class DurationKt {
    ...
    public static final long durationOf(long j, int i) {
        return Duration.m1328constructorimpl((j << 1) + i);
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:45:0x00a3 A[LOOP:1: B:37:0x0073->B:45:0x00a3, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:46:0x00b4 A[EDGE_INSN: B:46:0x00b4->B:47:0x00b4 BREAK  A[LOOP:1: B:37:0x0073->B:45:0x00a3], SYNTHETIC] */
    /*
    ...
    */
    ...
    private static final long parseOverLongIsoComponent(String str) {
        ...
        if (length - i > 16) {
            ...
            if (!(intRange instanceof Collection) || !((Collection) intRange).isEmpty()) {
                ...
                while (it2.hasNext()) {
                    if (!new CharRange('0', '9').contains(str.charAt(((IntIterator) it2).nextInt()))) {
                        z = false;
                        break;
                    }
                }
    ...
    private static final long m1453timeskIfJnKk(double d, long j) {
        return Duration.m1365timesUwyO8pc(j, d);
    }
    ...
    private static final long m1454timesmvk6XK0(int i, long j) {
        return Duration.m1366timesUwyO8pc(j, i);
    }
    ...
    public static final long toDuration(long j, @NotNull DurationUnit unit) {
        ...
        return new LongRange(-convertDurationUnitOverflow, convertDurationUnitOverflow).contains(j) ? durationOfNanos(DurationUnitKt.convertDurationUnitOverflow(j, unit, DurationUnit.NANOSECONDS)) : durationOfMillis(RangesKt.coerceIn(DurationUnitKt.convertDurationUnit(j, unit, DurationUnit.MILLISECONDS), -4611686018427387903L, MAX_MILLIS));
    }
}
