...
public final /* data */ class TimedValue<T> {
    ...
    public final TimedValue<T> m1482copyRFiDyg4(T value, long duration) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Intrinsics.areEqual(this.value, timedValue.value) && Duration.m1333equalsimpl0(this.duration, timedValue.duration);
    }
    ...
    public int hashCode() {
        T t = this.value;
        return ((t == null ? 0 : t.hashCode()) * 31) + Duration.m1356hashCodeimpl(this.duration);
    }

    @NotNull
    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + ((Object) Duration.m1377toStringimpl(this.duration)) + ')';
    }
}
