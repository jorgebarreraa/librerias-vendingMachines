...
public abstract class AbstractLongTimeSource implements TimeSource {
    ...
    private static final class LongTimeMark implements TimeMark {
        ...
        public TimeMark mo1322plusLRDsOJo(long duration) {
            return new LongTimeMark(this.startedAt, this.timeSource, Duration.m1364plusLRDsOJo(this.offset, duration), null);
        }
    }
    ...
    public TimeMark markNow() {
        return new LongTimeMark(read(), this, Duration.INSTANCE.m1430getZEROUwyO8pc(), null);
    }
