...
public final class MonotonicTimeSource implements TimeSource {
    ...
    public final long m1458adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m1467constructorimpl(LongSaturatedMathKt.m1456saturatingAddpTJri5U(timeMark, duration));
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m1459elapsedFrom6eNON_k(long timeMark) {
        return LongSaturatedMathKt.saturatingDiff(read(), timeMark);
    }

    @Override // kotlin.time.TimeSource
    public /* bridge */ /* synthetic */ TimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m1466boximpl(m1460markNowz9LOYto());
    }

    /* renamed from: markNow-z9LOYto, reason: not valid java name */
    public long m1460markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m1467constructorimpl(read());
    }
