...
class UCollectionsKt___UCollectionsKt {
    ...
    public static final int sumOfUByte(@NotNull Iterable<UByte> iterable) {
        ...
        int i = 0;
        while (it2.hasNext()) {
            i = UInt.m109constructorimpl(i + UInt.m109constructorimpl(it2.next().getData() & UByte.MAX_VALUE));
        }
        return i;
    }
    ...
    public static final int sumOfUInt(@NotNull Iterable<UInt> iterable) {
        ...
        int i = 0;
        while (it2.hasNext()) {
            i = UInt.m109constructorimpl(i + it2.next().getData());
        }
        return i;
    }
    ...
    public static final long sumOfULong(@NotNull Iterable<ULong> iterable) {
        ...
        long j = 0;
        while (it2.hasNext()) {
            j = ULong.m187constructorimpl(j + it2.next().getData());
        }
        return j;
    }
    ...
    public static final int sumOfUShort(@NotNull Iterable<UShort> iterable) {
        ...
        int i = 0;
        while (it2.hasNext()) {
            i = UInt.m109constructorimpl(i + UInt.m109constructorimpl(it2.next().getData() & UShort.MAX_VALUE));
        }
        return i;
    }
    ...
    public static final byte[] toUByteArray(@NotNull Collection<UByte> collection) {
        ...
        int i = 0;
        while (it2.hasNext()) {
            UByteArray.m95setVurrAj0(m84constructorimpl, i, it2.next().getData());
            i++;
        }
    ...
    public static final int[] toUIntArray(@NotNull Collection<UInt> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        int[] m162constructorimpl = UIntArray.m162constructorimpl(collection.size());
        Iterator<UInt> it2 = collection.iterator();
        int i = 0;
        while (it2.hasNext()) {
            UIntArray.m173setVXSXFK8(m162constructorimpl, i, it2.next().getData());
            i++;
        }
    ...
    public static final long[] toULongArray(@NotNull Collection<ULong> collection) {
        ...
        int i = 0;
        while (it2.hasNext()) {
            ULongArray.m251setk8EXiF4(m240constructorimpl, i, it2.next().getData());
            i++;
        }
    ...
    public static final short[] toUShortArray(@NotNull Collection<UShort> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        short[] m344constructorimpl = UShortArray.m344constructorimpl(collection.size());
        Iterator<UShort> it2 = collection.iterator();
        int i = 0;
        while (it2.hasNext()) {
            UShortArray.m355set01HTLdE(m344constructorimpl, i, it2.next().getData());
            i++;
        }
