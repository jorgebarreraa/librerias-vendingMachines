...
public class UComparisonsKt___UComparisonsKt {
    ...
    public static final int m1205maxOfMd2H83M(int i, @NotNull int... other) {
        Intrinsics.checkNotNullParameter(other, "other");
        int m169getSizeimpl = UIntArray.m169getSizeimpl(other);
        for (int i2 = 0; i2 < m169getSizeimpl; i2++) {
            i = UComparisonsKt.m1203maxOfJ1ME1BU(i, UIntArray.m168getpVg5ArA(other, i2));
        }
        return i;
    }
    ...
    public static final long m1206maxOfR03FKyM(long j, @NotNull long... other) {
        Intrinsics.checkNotNullParameter(other, "other");
        int m247getSizeimpl = ULongArray.m247getSizeimpl(other);
        for (int i = 0; i < m247getSizeimpl; i++) {
            j = UComparisonsKt.m1211maxOfeb3DHEI(j, ULongArray.m246getsVKNKU(other, i));
        }
        return j;
    }
    ...
    public static final byte m1209maxOfWr6uiD8(byte b, @NotNull byte... other) {
        Intrinsics.checkNotNullParameter(other, "other");
        int m91getSizeimpl = UByteArray.m91getSizeimpl(other);
        for (int i = 0; i < m91getSizeimpl; i++) {
            b = UComparisonsKt.m1204maxOfKr8caGY(b, UByteArray.m90getw2LRezQ(other, i));
        }
        return b;
    }
    ...
    public static final short m1213maxOft1qELG4(short s, @NotNull short... other) {
        Intrinsics.checkNotNullParameter(other, "other");
        int m351getSizeimpl = UShortArray.m351getSizeimpl(other);
        for (int i = 0; i < m351getSizeimpl; i++) {
            s = UComparisonsKt.m1202maxOf5PvTz6A(s, UShortArray.m350getMh2AYeg(other, i));
        }
        return s;
    }
    ...
    public static final int m1217minOfMd2H83M(int i, @NotNull int... other) {
        Intrinsics.checkNotNullParameter(other, "other");
        int m169getSizeimpl = UIntArray.m169getSizeimpl(other);
        for (int i2 = 0; i2 < m169getSizeimpl; i2++) {
            i = UComparisonsKt.m1215minOfJ1ME1BU(i, UIntArray.m168getpVg5ArA(other, i2));
        }
        return i;
    }
    ...
    public static final long m1218minOfR03FKyM(long j, @NotNull long... other) {
        Intrinsics.checkNotNullParameter(other, "other");
        int m247getSizeimpl = ULongArray.m247getSizeimpl(other);
        for (int i = 0; i < m247getSizeimpl; i++) {
            j = UComparisonsKt.m1223minOfeb3DHEI(j, ULongArray.m246getsVKNKU(other, i));
        }
        return j;
    }
    ...
    public static final byte m1221minOfWr6uiD8(byte b, @NotNull byte... other) {
        Intrinsics.checkNotNullParameter(other, "other");
        int m91getSizeimpl = UByteArray.m91getSizeimpl(other);
        for (int i = 0; i < m91getSizeimpl; i++) {
            b = UComparisonsKt.m1216minOfKr8caGY(b, UByteArray.m90getw2LRezQ(other, i));
        }
        return b;
    }
    ...
    public static final short m1225minOft1qELG4(short s, @NotNull short... other) {
        Intrinsics.checkNotNullParameter(other, "other");
        int m351getSizeimpl = UShortArray.m351getSizeimpl(other);
        for (int i = 0; i < m351getSizeimpl; i++) {
            s = UComparisonsKt.m1214minOf5PvTz6A(s, UShortArray.m350getMh2AYeg(other, i));
        }
        return s;
    }
}
