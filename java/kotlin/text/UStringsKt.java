...
public final class UStringsKt {
    ...
    public static final String m1316toStringJSWoG40(long j, int i) {
    ...
    public static final String m1317toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1318toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m1319toStringolVBNx4(short s, int i) {
    ...
    public static final UByte toUByteOrNull(@NotNull String str, int i) {
        ...
        if (UnsignedKt.uintCompare(data, UInt.m109constructorimpl(255)) > 0) {
            return null;
        }
    ...
    public static final UInt toUIntOrNull(@NotNull String str, int i) {
        ...
        int m109constructorimpl = UInt.m109constructorimpl(i);
        int i4 = 119304647;
        while (i3 < length) {
            ...
            if (UnsignedKt.uintCompare(i2, i4) > 0) {
                if (i4 == 119304647) {
                    i4 = UnsignedKt.m362uintDivideJ1ME1BU(-1, m109constructorimpl);
                    if (UnsignedKt.uintCompare(i2, i4) > 0) {
                    }
                }
                return null;
            }
            int m109constructorimpl2 = UInt.m109constructorimpl(i2 * m109constructorimpl);
            int m109constructorimpl3 = UInt.m109constructorimpl(UInt.m109constructorimpl(digitOf) + m109constructorimpl2);
            if (UnsignedKt.uintCompare(m109constructorimpl3, m109constructorimpl2) < 0) {
                return null;
            }
            i3++;
            i2 = m109constructorimpl3;
        }
        return UInt.m103boximpl(i2);
    }
    ...
    public static final ULong toULongOrNull(@NotNull String str, int i) {
        ...
        long m187constructorimpl = ULong.m187constructorimpl(i);
        long j2 = 0;
        ...
        while (i2 < length) {
            ...
            if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                if (j3 == 512409557603043100L) {
                    j3 = UnsignedKt.m364ulongDivideeb3DHEI(j, m187constructorimpl);
                    if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                    }
                }
                return null;
            }
            long m187constructorimpl2 = ULong.m187constructorimpl(j2 * m187constructorimpl);
            long m187constructorimpl3 = ULong.m187constructorimpl(ULong.m187constructorimpl(UInt.m109constructorimpl(r15) & 4294967295L) + m187constructorimpl2);
            if (UnsignedKt.ulongCompare(m187constructorimpl3, m187constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j2 = m187constructorimpl3;
            j = -1;
        }
    ...
    public static final UShort toUShortOrNull(@NotNull String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (UnsignedKt.uintCompare(data, UInt.m109constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m287boximpl(UShort.m293constructorimpl((short) data));
    }
}
