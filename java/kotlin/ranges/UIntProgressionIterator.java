...
final class UIntProgressionIterator implements Iterator<UInt>, KMappedMarker {
    ...
    private UIntProgressionIterator(int i, int i2, int i3) {
        ...
        this.hasNext = z;
        this.step = UInt.m109constructorimpl(i3);
    ...
    public /* bridge */ /* synthetic */ UInt next() {
        return UInt.m103boximpl(m1247nextpVg5ArA());
    }

    /* renamed from: next-pVg5ArA, reason: not valid java name */
    public int m1247nextpVg5ArA() {
        int i = this.next;
        if (i != this.finalElement) {
            this.next = UInt.m109constructorimpl(this.step + i);
        } else {
            if (!this.hasNext) {
