...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1253fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int m187constructorimpl = ((int) ULong.m187constructorimpl(j ^ ULong.m187constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int m187constructorimpl2 = (m187constructorimpl + ((int) ULong.m187constructorimpl(j2 ^ ULong.m187constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return ((int) (j3 ^ (j3 >>> 32))) + m187constructorimpl2;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) ULong.m232toStringimpl(this.first));
            sb.append("..");
            sb.append((Object) ULong.m232toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
